...
public class DinoponeraAntsController : MonoBehaviour
{
    ...
    private DinoponeraAntsStats dinoponeraAntsStats;    // Get The Dinoponera Ants Stats like damage, armor,...
    ...
    private void Start()
    {
        ...
        dinoponeraAntsStats = GetComponent<DinoponeraAntsStats>();
    }
