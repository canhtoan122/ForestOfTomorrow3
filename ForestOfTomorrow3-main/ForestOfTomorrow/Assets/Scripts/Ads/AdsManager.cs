...
public class AdsManager : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener, IUnityAdsInitializationListener
{
    ...
    public Action<UnityAdsShowCompletionState> OnAdFinish;
    ...
    public void ShowAd()
    {
        ...
        {
            Debug.LogWarning("Show ads fail");
        }
    }
    ...
    {
        OnAdFinish?.Invoke(showCompletionState);
        Debug.Log("Show ads complete");
        Time.timeScale = 1f;
